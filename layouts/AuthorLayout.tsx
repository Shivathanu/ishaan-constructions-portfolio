      ...
      <div className="max-container padding-container bg-blue-900 h-screen py-20 divide-y divide-gray-200 dark:divide-gray-200">
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          ...
          <div className="prose max-w-none pb-8 pt-8 dark:prose-invert xl:col-span-2">
            <p>Ishaan Constructions is a dynamic and dedicated small construction company specializing in delivering
            ...
            <p>At Ishaan Constructions, our mission is to provide exceptional construction services tailored to the
